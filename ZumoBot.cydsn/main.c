...
// Week 2:Assigment 3 battery level
#if 0
void zmain(void) {
    ...
    while(true) {
        if (but == 0 ) {
        startBlink(1, 500, 500);
        }
        if (SW1_Read() == 0 && getBatterVoltage(runningNumber) > 4) {
            runningNumber++;
            but = 1;
        }
        if ( getBatterVoltage(runningNumber) < 4) {
            runningNumber++;
            but = 0;
...
#endif
// Week 3: Assigment 1, simple motors
#if 0
//motor
void zmain(void)
...
{   
    ...
    if (SW1_Read()==0) {
        ...
        vTaskDelay(3000);
         ...
         motor_turn(100,94,3700);     // moving forward
        motor_turn(100,0,1150);     // turn
        motor_turn(100,94,3000);
        motor_turn(100,0,1320);     // turn
        motor_turn(100,94,3000);
        motor_turn(100,0,1400);
        motor_turn(120,50,4000);
        motor_turn(100,94,2000);
         // moving backward
